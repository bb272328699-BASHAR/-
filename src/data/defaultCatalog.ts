...
export const DEFAULT_TOOLS: Tool[] = [
  ...
  {
    id: 'tool-flux-1',
    name: 'فلوكس 1 (FLUX.1 by Black Forest Labs)',
    slug: 'flux-1',
    tagline: 'أحدث نموذج مفتوح المصدر لتوليد الصور فائقة الواقعية بمطابقة استثنائية للنصوص والتفاصيل البشرية',
    description: 'نموذج ثوري طوره الفريق الأصلي خلف Stable Diffusion (Black Forest Labs) يتميز بفهم دقيق للأوامر الطويلة المعقدة، ورسم أصابع اليد والملامح بدقة تامة، وطباعة نصوص واضحة داخل الصور.',
    overview: 'يأتي FLUX.1 بثلاث نسخ (pro وdev وschnell) ليلبي مختلف الاحتياجات من الاستخدام المحلي السريع إلى الجودة التجارية القصوى المنافسة لميدجورني.',
    ...
    features: [
      { title: 'طباعة نصوص واضحة داخل الصورة', description: 'القدرة الفائقة على كتابة لافتات وعبارات بدقة وحروف صحيحة داخل المشهد' },
      { title: 'محاكاة فائقة للتشريح البشري', description: 'رسم واقعي ومتقن لأصابع اليد وتعبيرات الوجه والجلد الطبيعي' },
      { title: 'مفتوح المصدر وخيارات تشغيل متعددة', description: 'تشغيل محلي على أجهزة الكمبيوتر الشخصية أو عبر واجهات الويب السحابية' },
    ],
    pros: ['دقة واقعية تنافس وتتفوق أحياناً على Midjourney v6', 'مجاني ومتاح بنسخ مفتوحة المصدر (Schnell و Dev)', 'التزام ممتاز بتفاصيل الوصف المكتوب'],
    cons: ['النسخة الاحترافية Pro تتطلب واجهات API مدفوعة أو بطاقات رسومية قوية'],
    pricingPlans: [
      { plan_name: 'FLUX.1 Schnell / Dev', price: '0$', period: 'دائم', features: ['تنزيل وتشغيل محلي مجاني', 'أوزان مفتوحة', 'توليد سريع'], is_popular: true },
      { plan_name: 'FLUX.1 Pro API', price: '0.05$ / صورة', period: 'حسب الاستهلاك', features: ['أعلى جودة واقعية', 'أسرع رندرة سحابية', 'ترخيص تجاري مباشر'], is_popular: false },
    ],
    faqs: [
      { question: 'هل يمكن تجربة FLUX.1 مجاناً بدون كرت شاشة قوي؟', answer: 'نعم، يتوفر النموذج للتجربة المجانية على منصات مثل HuggingFace و Replicate و Fal.ai دون الحاجة لجهاز خارق.' },
      { question: 'هل يطبع الكلمات بدقة داخل الصور؟', answer: 'نعم، يتميز FLUX.1 كأحد أفضل النماذج عالمياً في كتابة النصوص واللوحات والشعارات داخل المشاهد التوليدية بدقة بالغة.' },
    ],
  },
  {
    id: 'tool-chatgpt',
