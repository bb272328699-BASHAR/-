...
export const ROUTE_SEO_MAP: Record<string, SEOConfig> = {
  ...
  '/sitemap': {
    title: 'خريطة الأدوات والموقع الشاملة (HTML Sitemap) | دليل الذكاء الاصطناعي',
    description: 'الفهرس التفاعلي الكامل لكافة أدوات وتصنيفات ومقالات ومقارنات الذكاء الاصطناعي، لتسهيل التصفح والأرشفة لمحركات البحث.',
    keywords: 'خريطة الأدوات, خريطة الموقع, فهرس الذكاء الاصطناعي, HTML Sitemap, دليل AI',
    ogType: 'website'
  },
  '/tools-sitemap': {
    title: 'خريطة الأدوات والموقع الشاملة (HTML Sitemap) | دليل الذكاء الاصطناعي',
